 ...
 * 如果aop配置了暴露当前代理，currentProxy()这方法就可以使用
 * <p>
 * <p>
 * It returns the AOP proxy in use. Target objects
 ...
 * 目标对象或者advice可以用aop proxy 实现增强调用
 * <p>
 * <p>
 ...
 * to resources on the invocation.
 * <p>
 ...
 *
 *
 * spring 事务处理时 自我调用的一种实现方式
 * public void a(){
 *  this.b();//this是目标对象  直接使用是不行的，不能是b上的事务生效
 *            //1.修改为((AService) AopContext.currentProxy()).b();
 *          // 2.还可以通过ApplicationContext获取当前service的当前实现类
 *          // 从上下文获取代理对象
 *          //此种方法不适合于prototype Bean，因为每次getBean返回一个新的Bean
 *          //((AService)ApplicationContext.getBean(AService.class)).b().
 * }
 *
 *
 *
